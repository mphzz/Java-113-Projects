 ...
 String accountNumber;
  Customer customer;
   ...
   public String addAccount(String customerName, String customerAddress,int customerAge, String customerPhoneNumber, int customerType, int typeAccount){
     ...
     accountNumber = Integer.toString(currentNumber++);
  ...
  System.out.println("testtt" + accountNumber);
   int index = Integer.parseInt(accountNumber);
     System.out.println(index);
   return Double.toString(accounts[index-1].deposit(amount));
   }
   ...
   */
   ...
   int numberNeeded = Integer.parseInt(accountNumber);
